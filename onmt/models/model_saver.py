...
class ModelSaver(ModelSaverBase):
    ...
    def _save(self, step):
        ...
        logger.info("Saving checkpoint %s_step_%d.pt" % (self.base_path + "-Ver-" + str(VERSION) + "-SET-" + str(SET), step))
        checkpoint_path = '%s_step_%d.pt' % (self.base_path + "-Ver-" + str(VERSION) + "-SET-" + str(SET), step)
