...
def model_opts(parser):
    ...
    group.add_argument('-encoder_type', type=str, default='brnn',#rnn
    ...
    group.add_argument('-enc_layers', type=int, default=2,#2
                       help='Number of layers in the encoder')
    group.add_argument('-dec_layers', type=int, default=2,#2
                       help='Number of layers in the decoder')
    group.add_argument('-rnn_size', type=int, default=500,#500
    ...
    group.add_argument('-global_attention', type=str, default='mlp',
...
def preprocess_opts(parser):
    ...
    group.add_argument('-max_shard_size', type=int, default=0,#0
    ...
    group.add_argument('-shuffle', type=int, default=0,#1
                       help="Shuffle data")
...
def train_opts(parser):
    ...
    group.add_argument('-save_model', default='model',
                       ...
                       of steps""")
    group.add_argument('-freeze_d', default=True)
    ...
    group.add_argument('-seed', type=int, default=2222,
    ...
    group.add_argument('-max_generator_batches', type=int, default=32,
                       help="""Maximum batches of words in a sequence to run
                        ...
                        uses more memory.""")
    group.add_argument('-train_steps', type=int, default=300000,#100000
                       help='Number of training steps')
    group.add_argument('-epochs', type=int, default=0,
                       help='Deprecated epochs see train_steps')
    group.add_argument('-optim', default='adam',#sgd
    ...
    group.add_argument('-learning_rate', type=float, default=0.001,#1.0
